...
"A:1.3.1",
"Q:If a product sets a time limit for user input, which WCAG relates to users being able to adjust or turn off the time limit?",
"A:2.2.1",
"Q:Which WCAG relates to providing instructions to users when they need to input data?",
"A:3.3.2",
...
"A:3.3.3",
"Q:Which Level AA WCAG relates to helping users understand what information is contained on a page and how that information is organized.",
"A:2.4.6",
"Q:Which WCAG relates to helping users know the meaning of acronyms shown in content?",
"A:3.1.4",
...
"A:3.2.1",
"Q:Which WCAG relates to users being able to turn off animation that occurs when the user clicks a button?",
"A:2.3.3",
...
"A:4.1.3",
"Q:Which WCAG relate to users navigating through links with the keyboard following an intuitive path, and knowing which link has keyboard focus?",
"A:2.4.3,2.4.7",
